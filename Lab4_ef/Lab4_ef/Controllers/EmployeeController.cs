...
// POST: Employees/Create 
        ...
        public async Task<IActionResult> Create([Bind("EmployeeId,FirstName,LastName, Age")]
            Employee employee) {
...
// POST: Employees/Edit/5 
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EmployeeId,FirstName,LastName, Age")]
            Employee employee) {
